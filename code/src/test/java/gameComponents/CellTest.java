...
class CellTest {
    ...
    void setUp() {
        cell = new Cell(2, 3);
        worker = new Worker(src.main.java.gameComponents.PlayerColor.RED);
    }
    ...
    void testCellInitialization() {
        ...
        assertEquals(WorkerStatus.ABSENT, cell.getStatus(), "Initial worker status should be ABSENT");
    ...
    void testSetWorker() {
        ...
        assertEquals(WorkerStatus.PRESENT, cell.getStatus(), "Worker status should be PRESENT after setting worker");
    ...
    void testRemoveWorker() {
        cell.setWorker(worker);
        cell.removeWorker();
        assertEquals(WorkerStatus.ABSENT, cell.getStatus(), "Worker status should be ABSENT after removal");
