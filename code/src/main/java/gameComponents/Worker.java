 ...
 * Each worker has a unique ID and belongs to a specific {@link PlayerColor}.
 */
public class Worker {
    ...
    /**
     * Constructs a Worker belonging to a specified player color.
     * Also acquires a unique ID from {@link IDMaker}.
     *
