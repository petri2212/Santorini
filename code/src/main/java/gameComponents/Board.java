...
/**
 * The Board class holds a 2D array of Cell objects, representing a 5x5 grid
 * in the Santorini board game.
 */
public class Board {
    ...
    /**
     * A 2D array representing the game board, where each cell can
     * contain Towers or Workers.
     */
    private Cell[][] board;

    /**
     * Constructs a Board of size h x w (standard 5x5), initializing each cell
     * with a new {@link Cell} instance.
     * 
