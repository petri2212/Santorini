...
public abstract class Controller <T extends View> {
	 ...
	 * Null view will cause the constructor to throw a MVCNoViewException.
	 *
	 * @param model	is the reference to the GameManager instance that contains the business logic
	 * @param view 	is the reference to the View instance that contains the visual output
	 */
	...
	/**
	 * Initializes the listeners of the controlled View.
	 * This method is called inside the constructor to be sure not to forget to call this method.
	 */
	protected abstract void initViewListeners();

	/**
	 * Loads the view and call the method show() of the View interface.
	 * Using this function instead of directly view.show() assures that the Controller is ready
