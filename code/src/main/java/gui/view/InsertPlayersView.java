 ...
 * it is the splitter for the graphic and the console for the insert players page.
 */
public abstract class InsertPlayersView implements View {
	...
	/**
	 * Those methods are all warnings and they are abstract
	 * because the override of the method is in the graphic or in the console.
	 */
