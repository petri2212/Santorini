 ...
 * the classes {@link Player} and {@link Worker}.
 */
public class IDMaker {
	...
	/**
	 * Returns the single instance of {@code IDMaker}. Creates one if it does not
	 * exist.
	 *
	...
	/**
	 * Returns the current value of the incremental ID without incrementing it.
	 *
